...
- beware not to short-circuit accidently pins or other parts on any component
...
**Description:** Collects information about temperature and humidity.
...
### microUSB socket
**Purpose:** Use it in final device to provide power from USB Power Supply.
...
**Task:** Wire up the parts and write a MicroPython module, which will collect, parse and return sensor data. In repository  you will find a file named todo, which contains a driver (created by Paweł Kucmus), that will provide a basic access to the air quality sensor.
...
- microUSB 5V / 2,5A power supply
- microUSB B - A cable
- todo (ile przewodów), inne części, breadboard?
...
- microUSB 5V / 2,5A power supply
- microUSB B - A cable
- todo przewody, inne części, breadboard?
...
**Reference:**
- todo (mamy jakiś reference dla drivera?)
